...
function rowsForJurisdiction(jurisdictionCode?: string): RowSpec[] {
  ...
  return [
    ...
    },
    {
      ...
      group: "monthly",
      better: "lower",
      baselineValue: (baseline) => Math.abs(baseline.retirement_income_gap_annual),
      scenarioValue: (scenario) => Math.abs(scenario.results.retirement_income_gap_annual),
    },
    {
      ...
      group: "monthly",
      better: "higher",
      baselineValue: (baseline) => baseline.retirement_income_parity_ratio ?? 0,
      scenarioValue: (scenario) => scenario.results.retirement_income_parity_ratio ?? 0,
    },
    {
      key: "maintenance",
